...
var recordEvents = __webpack_require__(12);
...
var config = {
  apiOrigins: {
    production: 'https://onermtracker.herokuapp.com/'
  }
};
...
var onSignUp = function onSignUp(event) {
  ...
  api.signUp(data).then(ui.signUpSuccess).then($('#error-message').fadeIn(1000).delay(3000).fadeOut(1000)).catch(ui.signUpFailure).catch($('#error-message').fadeIn(1000).delay(3000).fadeOut(1000));
};
...
var onLogOut = function onLogOut(event) {
  event.preventDefault();
  api.userLogout().then(ui.logoutSuccess).catch(ui.logoutFailure);
};

var onDeleteRecord = function onDeleteRecord(event) {
  var id = this.getAttribute('data-id');
  console.log(event);
  event.preventDefault();
  api.deleteRecord(id).then(ui.deleteRecordSuccess).catch(ui.deleteRecordFail);
};

var onRecordHistory = function onRecordHistory(event) {
  event.preventDefault();
  api.recordHistory().then(ui.getRecordSuccess).catch(ui.getRecordsFail);
};

var onNewRecord = function onNewRecord(event) {
  event.preventDefault();
  api.newRecord().then(ui.newRecordSuccess).catch(ui.newRecordFail);
};

var onUpdateRecord = function onUpdateRecord(event) {
  event.preventDefault();
  var chest = $('.input-chest').val();
  var tricep = $('.input-tricep').val();
  var bicep = $('.input-bicep').val();
  var deadlift = $('.input-deadlift').val();
  var squat = $('.input-squat').val();
  var personalNotes = $('.input-personal_notes').val();
  var recordId = $('#edit-modal').data('id');
  api.updateRecord(chest, tricep, bicep, deadlift, squat, personalNotes, recordId).then(ui.updateRecordSuccess).catch(ui.updateRecordFail);
};

var onEditButtonClick = function onEditButtonClick(event) {
  event.preventDefault();
  var chest = $(this).data('chest');
  var bicep = $(this).data('bicep');
  var tricep = $(this).data('tricep');
  var deadlift = $(this).data('deadlift');
  var squat = $(this).data('squat');
  var personal_notes = $(this).data('personalNotes');
  var id = $(this).data('id');
...
var updateRecord = function updateRecord(chest, tricep, bicep, deadlift, squat, personalNotes, recordId) {
...
var recordHistory = function recordHistory() {
  return $.ajax({
...
// create new record
var newRecord = function newRecord(chest, tricep, bicep, deadlift, squat, personal_notes) {
  return $.ajax({
    url: app.host + 'records/',
    headers: {
      Authorization: 'Token token=' + app.user.token
...
var app = __webpack_require__(4);
var oneRepMaxHandlebarsTemplate = __webpack_require__(16);

var message = function message(msg) {
  $('#error-message').text(msg);
};

var fadeMessage = function fadeMessage(msg) {
...
var getRecordsFail = function getRecordsFail(error) {
  console.log('Failed in getRecordsFail');
  console.error(error);
};

var getRecordSuccess = function getRecordSuccess(data) {
  $('#new-record').show();
  $('#stat-table').show();
  console.log('ui data');
  console.log(data);
  ...
  var oneRepMaxTemplate = oneRepMaxHandlebarsTemplate(context);
  $('#stat-table').append(oneRepMaxTemplate);
};

var updateRecordSuccess = function updateRecordSuccess(data) {
  console.log('updateRecordSuccess');
  console.log(data);
};

var updateRecordFail = function updateRecordFail(error) {
  console.log('updateRecordFail');
  console.error(error);
};

var deleteRecordSuccess = function deleteRecordSuccess(data) {
...
var deleteRecordFail = function deleteRecordFail(error) {
  console.log('deleteRecordFail');
  console.error(error);
};

var newRecordSuccess = function newRecordSuccess(data) {
...
var newRecordFail = function newRecordFail(error) {
...
module.exports = {
  ...
  updateRecordFail: updateRecordFail,
  deleteRecordSuccess: deleteRecordSuccess,
  deleteRecordFail: deleteRecordFail,
  getRecordSuccess: getRecordSuccess,
  getRecordsFail: getRecordsFail,
  newRecordSuccess: newRecordSuccess,
  newRecordFail: newRecordFail
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "        <tr>\n          <td>"
    + alias2(alias1((depth0 != null ? depth0.chest : depth0), depth0))
    + "</td>\n          <td>"
    + alias2(alias1((depth0 != null ? depth0.tricep : depth0), depth0))
    + "</td>\n          <td>"
    + alias2(alias1((depth0 != null ? depth0.bicep : depth0), depth0))
    + "</td>\n          <td>"
    + alias2(alias1((depth0 != null ? depth0.deadlift : depth0), depth0))
    + "</td>\n          <td>"
    + alias2(alias1((depth0 != null ? depth0.squat : depth0), depth0))
    + "</td>\n          <td>"
    + alias2(alias1((depth0 != null ? depth0.personal_notes : depth0), depth0))
    + "</td>\n          <td>\n            <button type=\"button\" class=\"btnEditRecord\" data-id="
    ...
    + "\" data-personalNotes=\""
    + alias2(alias1((depth0 != null ? depth0.personal_notes : depth0), depth0))
    + "\" data-toggle=\"modal\" data-target=\"#edit-modal\" data-id="
    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
    + ">edit record</button>\n          </td>\n          <td>\n            <button class=\"delete-record\" data-id=\""
    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
    + "\" class=\"btn-success btn span3\">Delete Record</button>\n          </td>\n        </tr>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "<div id=\"1RM-template\">\n    <table class=\"table\">\n      <thead class=\"thead-default\">\n        <tr>\n          <th>Chest</th>\n          <th>Tricep</th>\n          <th>Bicep</th>\n          <th>Deadlift</th>\n          <th>Squat</th>\n          <th>Personal Notes</th>\n        </tr>\n      </thead>\n      <tbody>\n"
    ...
    + "  </tbody>\n</table>\n\n  <!--modal-->\n  <div class=\"modal fade\" id=\"edit-modal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\">\n  <div class=\"modal-dialog\" role=\"document\">\n  <div class=\"modal-content\">\n  <div class=\"modal-header\">\n    <h5 class=\"modal-title\" id=\"exampleModalLabel\">Edit Record</h5>\n    <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n    <span aria-hidden=\"true\">&times;</span>\n  </button>\n  </div>\n  <div class=\"modal-body\">\n    <form>\n      <div class=\"form-group\">\n        <label class=\"form-control-label\">Chest:</label>\n        <input type=\"text\" class=\"form-control input-chest\" value=\""
    + alias2(alias1((depth0 != null ? depth0.chest : depth0), depth0))
    + "\">\n      </div>\n      <div class=\"form-group\">\n        <label class=\"form-control-label\">Tricep:</label>\n        <input type=\"text\" class=\"form-control input-tricep\" value=\""
    + alias2(alias1((depth0 != null ? depth0.tricep : depth0), depth0))
    + "\">\n      </div>\n      <div class=\"form-group\">\n        <label class=\"form-control-label\">Bicep:</label>\n        <input type=\"text\" class=\"form-control input-bicep\" value=\""
    + alias2(alias1((depth0 != null ? depth0.bicep : depth0), depth0))
    + "\">\n      </div>\n      <div class=\"form-group\">\n        <label class=\"form-control-label\">Deadlift:</label>\n        <input type=\"text\" class=\"form-control input-deadlift\" value=\""
    + alias2(alias1((depth0 != null ? depth0.deadlift : depth0), depth0))
    + "\">\n      </div>\n      <div class=\"form-group\">\n        <label class=\"form-control-label\">Squat:</label>\n        <input type=\"text\" class=\"form-control input-squat\" value=\""
    + alias2(alias1((depth0 != null ? depth0.squat : depth0), depth0))
    + "\">\n      </div>\n      <div class=\"form-group\">\n        <label class=\"form-control-label\">Personal Notes:</label>\n        <input class=\"form-control input-personal_notes\" value=\""
    + alias2(alias1((depth0 != null ? depth0.personal_notes : depth0), depth0))
    + "\"></input>\n      </div>\n    </form>\n  </div>\n  <div class=\"modal-footer\">\n    <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Close</button>\n    <button type=\"button\" class=\"update-record\" class=\"btn btn-secondary\" data-id=\""
    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
